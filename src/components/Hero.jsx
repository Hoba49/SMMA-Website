...
const Hero = () => (
    ...
    flex-col ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 p x-6`}>
        ...
        <p className={`${styles.paragraph} ml-2`}>
          ...
          items-center w-full'>
            ...
            ss:leading-[100px] leading-[75px]'>
              INSERT <br className="sm:block 
              hidden"/> {" "}
              <span className='text-gradient'>MOTTO</
              span> {" "}
          ...
          <h1 className='font-poppins font-semibold 
            ...
            ss:leading-[100px] leading-[75px] w-full'> HERE </h1>
            <p className={`${styles.paragraph} 
              max-w-[470px] mt-5`}>At [Agency Name], our mission is to empower 
              businesses and brands through innovative 
              social media marketing strategies. 
              We are committed to fostering meaningful 
              connections, amplifying brand presence, 
              and driving sustainable growth in the 
              dynamic world of social media.</p>
      ...
      <div className='absolute z-[0] w-[50%] h-[550%]
