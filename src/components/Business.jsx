  ...
  return (
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
        <h2 className={`${styles.heading2} ml-20`}>Show us your business, <br className='sm:block
        hidden'/> we'll handle the marketing
        </h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5 ml-20`}>[Insert description here]</p>

        <Button styles="mt-10 ml-20" />
      </div>
