...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        market your <br className='sm:block
        hidden'/>business & product</h2>
        ...
        mt-6'>
          ...
          w-[128px] h-[42px] object-containt mr-5
          cursor-pointer'/>
          <img src={google} alt="apple_store" className='
          w-[128px] h-[42px] object-containt
          cursor-pointer'/>
